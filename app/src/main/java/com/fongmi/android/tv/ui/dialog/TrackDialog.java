...
import com.fongmi.android.tv.player.ijk.IjkTrackNameProvider;
...
public final class TrackDialog extends BaseDialog implements TrackAdapter.OnClickListener {
    ...
    private final IjkTrackNameProvider ijkProvider;
    ...
    public TrackDialog() {
        ...
        this.ijkProvider = new IjkTrackNameProvider();
    }
    ...
    protected void initEvent() {
        binding.size.setOnClickListener(this::onSubtitle);
    ...
    private void addIjkTrack(List<Track> items) {
        ...
        for (int i = 0; i < trackInfos.size(); i++) {
            ...
            Track item = new Track(type, ijkProvider.getTrackName(trackInfo));
            item.setPlayer(player.getPlayer());
